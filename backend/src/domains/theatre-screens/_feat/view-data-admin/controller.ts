/**
 * @fileoverview Express controller for the Theatre TheatreScreen details administrative view.
...
import {fetchTheatreScreenDetailsViewData} from "@/domains/theatre-screens/_feat/view-data-admin/service/service";
