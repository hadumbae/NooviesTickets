...
import {TheatreScreenInputSchema} from "@/domains/theatre-screen/_feat/validate-submit";
import {TheatreScreenQueryMatchStageSchema, TheatreScreenQuerySortStageSchema} from "@/domains/theatre-screen/_feat/validate-query";
...
} from "@/domains/theatre-screen/_feat/query-population";
import {
    create,
    destroy,
    find,
...
import {deriveTheatreScreenData} from "@/domains/theatre-screen/_feat/crud/deriveTheatreScreenData";
