...
import type {FetchTheatreInfoViewRouteConfig} from "@/domains/theatres/_feat/client-view-data/theatre-info/FetchTheatreInfoViewRouteConfigSchema";

import {
    fetchTheatreInfoViewData
} from "@/domains/theatres/_feat/client-view-data/theatre-info/fetchTheatreInfoViewData";
