...
import {z} from "zod";
import {QueryOptionParamsSchema, QueryPaginationParamsSchema} from "@/shared/_schema";

/** Zod schema for validating pagination and query option parameters for the current user's review list. */
export const MyMovieReviewListRouteConfigSchema = QueryPaginationParamsSchema.merge(QueryOptionParamsSchema);
