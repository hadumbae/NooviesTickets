 ...
 *
 * Values are taken from `AcceptedImageTypeConstant`, which is a readonly array of supported image MIME strings,
 * e.g., "image/jpeg", "image/png", "image/webp", etc.
 */
const ALLOWED_IMAGE_TYPES = new Set<string>(AcceptedImageTypeConstant);
