...
import {z} from "zod";
import {ISO8601DateTimeSchema, DateTimeInstanceSchema} from "../date-time";

/** Zod schema for validating model timestamps as ISO-8601 strings or DateTime instances. */
export const MongooseTimestampDateTimeSchema = z.union(
...
export type MongooseTimestampDateTime = z.infer<typeof MongooseTimestampDateTimeSchema>;
