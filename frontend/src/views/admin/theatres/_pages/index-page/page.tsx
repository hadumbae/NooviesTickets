...
import {
    TheatreQueryOptionsSchema
} from "@/domains/theatres/_feat/handle-query-options/options/TheatreQueryOptionsSchema.ts";
...
export function TheatreIndexPage(): ReactElement {
    useSetAdminPageTitle({presetTitle: "Theatres"});
