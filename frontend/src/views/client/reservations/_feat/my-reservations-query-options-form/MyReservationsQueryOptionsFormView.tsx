...
/** Props for the MyReservationsQueryOptionsFormView component. */
type ViewProps = {
    className?: string
};
 ...
 */
export function MyReservationsQueryOptionsFormView(
    {className}: ViewProps
): ReactElement {
    ...
    if (!submitHandler) {
        throw new Error(`'${MyReservationsQueryOptionsFormView.name}' requires a submit handler.`);
    }
