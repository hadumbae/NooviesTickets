...
import {useLogoutAuthUser} from "@/domains/authentication/_feat/manage-auth-user-data/useLogoutAuthUser.ts";
...
import {postLogoutUser} from "@/domains/authentication/_feat/user-logout/postLogoutUser.ts";
