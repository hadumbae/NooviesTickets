...
import {fetchTheatreScreensWithShowings} from "@/domains/theatre-screens/_feat/client-view-data/repository";
 ...
 */
export function useFetchTheatreScreensWithShowings(
    ...
    const fetchScreens = buildQueryFn<TheatreScreenSchedule[]>({
        action: () => fetchTheatreScreensWithShowings({theatreID, localDate: dateString}),
