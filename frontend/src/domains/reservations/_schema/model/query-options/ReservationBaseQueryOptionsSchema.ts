...
export const ReservationBaseQueryOptionsSchema = ReservationBaseQueryFilterSchema.merge(ReservationBaseQuerySortSchema);

/** Type definition for reservation base query options inferred from the schema. */
export type ReservationBaseQueryOptions = z.infer<typeof ReservationBaseQueryOptionsSchema>;
