...
import {createFormHook} from "@/shared/_feat";
import {
    createMultiStepFormContainer,
    FactoryMultiStepFormContainerProps,
} from "@/shared/_feat/forms/create-multi-step-form/createMultiStepFormContainer.tsx";
...
> = {
    ...
    SubmitForm: (props: FactoryMultiStepFormContainerProps<TFormValues, TForm, TEditEntity, TReturns, TMutConfig>) => ReactElement;
};
...
>(
    ...
    const SubmitForm = createMultiStepFormContainer<TFormValues, TForm, TEditEntity, TReturns, TMutConfig>({
        useSubmitForm,
        formName,
        mutation,
    });
