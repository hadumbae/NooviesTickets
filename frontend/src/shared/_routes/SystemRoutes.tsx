        ...
        children: [
            {
                path: "*",
                lazy: async () => {
                    const {NotFoundPage} = await import("@/views/shared/_pages/error/NotFoundPage.tsx");
        ...
        children: [
            {
                path: "/error",
                lazy: async () => {
                    const {ErrorPage} = await import("@/views/shared/_pages/error/ErrorPage.tsx");
            ...
            },
            {
                ...
                lazy: async () => {
                    const {UnauthorizedPage} = await import("@/views/shared/_pages/error/UnauthorizedPage.tsx");
